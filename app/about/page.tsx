    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 py-16 sm:py-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-6 rounded-lg overflow-x-auto mb-4">
  ...
  -d '{
    ...
    "coverImage": "https://example.com/image.jpg"
          ...
          <ol className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>2. Copy <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">.env.example</code> to <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">.env</code></li>
            <li>3. Set your <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">API_KEY</code> in the <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">.env</code> file</li>
            <li>4. Install dependencies: <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">npm install</code></li>
            <li>5. Run the development server: <code className="text-sm bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-2 py-1 rounded">npm run dev</code></li>
